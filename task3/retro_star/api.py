...
class RSPlanner:
    def __init__(self,
                 ...
                 iterations=500,
                 use_value_fn=False,
                 starting_molecules=dirpath+'/Multi-Step task/starting_mols.pkl/starting_mols.pkl',
...
if __name__ == '__main__':
    ...
    with open('retro_star/retro_star/Multi-Step task/test_mols.pkl', 'rb') as f:
        test_mols = pickle.load(f)
    
    for test_mol in test_mols:
        result= planner.plan(test_mol)
        print(result)
